    ...
    <div class="container" style="width: 30%">
        <asp:UpdatePanel ID="questionPanel" runat="server" CssClass="container">
            <ContentTemplate>
                ...
                <asp:Button ID="ans0" runat="server" CssClass="menuButton" Visible="false" Width="100%" Height="20%" Text="Click me!" OnClick="buttonClick" /><br />
                <asp:Button ID="ans1" runat="server" CssClass="menuButton" Visible="false" Width="100%" Height="20%" Text="Click me!" OnClick="buttonClick" /><br />
                <asp:Button ID="ans2" runat="server" CssClass="menuButton" Visible="false" Width="100%" Height="20%" Text="Click me!" OnClick="buttonClick" /><br />
                <asp:Button ID="ans3" runat="server" CssClass="menuButton" Width="100%" Height="20%" Text="Click me!" OnClick="buttonClick" /><br />
